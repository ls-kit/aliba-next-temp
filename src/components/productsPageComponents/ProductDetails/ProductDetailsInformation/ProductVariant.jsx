        ...
        <div className="w-100 flex flex-col justify-content-center align-items-center ">
                        ...
                        <div className="p-2 text-center">
                            ...
                            >
                                ...
                                {productCategoryShippingRates?.map((productType) => {
                                    ...
                                    return (
                                        <option key={id} value={shipping_rate}>
                                            {category}
                                        </option>
                                    );
                                })}
            ...
            <div className="my-5">
                <div className="w-100 d-flex flex-column justify-content-between align-items-center">
                    <button className="btn btn-solid btn-sm p-1 text-sm text-center w-100 rounded-pill">
                        {" "}
                        <i class="fa-solid fa-heart"></i> Add to wishlist
                    </button>
                    <button className="btn btn-solid btn-sm p-1 text-sm text-center w-100 rounded-pill my-1">
                        {" "}
                        <i class="fa-solid fa-cart-flatbed"></i> Add to cart
                    </button>
                    <button className="btn btn-solid btn-sm p-1 text-sm text-center w-100 rounded-pill">
                        {" "}
                        <i class="fa-solid fa-money-bill-1-wave"></i> Buy now
                    </button>
                </div>
            </div>
        </div>
