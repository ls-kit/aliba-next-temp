                        ...
                        <ul className="nav nav-tabs nav-material" id="top-tab" role="tablist">
                            ...
                            <li className="nav-item">
                                <a
                                    ...
                                    aria-selected="false"
                                >
                                    <i className="icofont icofont-man-in-glasses"></i>Specification
                                </a>
                                <div className="material-border"></div>
                            </li>
                            <li className="nav-item">
                                ...
                                <div className="product-tab-discription">
                                    <div className="part">
                                        <p>
                                            ...
                                            actual blouse would look like.it has text written on it
                                            in a black cursive language which looks great on a white
                                            color.
                                        </p>
                                    </div>
                                    <div className="part">
                                        ...
                                        <p>
                                            Art silk is manufactured by synthetic fibres like rayon.
                                            It's light in weight and is soft on the skin for comfort
                                            in summers.Art silk is manufactured by synthetic fibres
                                            like rayon. It's light in weight and is soft on the skin
